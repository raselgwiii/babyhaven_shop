      ...
      <div class="row">
        ...
        <div class="col-sm-9 padding-right">
          <div class="features_items"><!--features_items-->
            ...
            $query = "SELECT * FROM `tblproduct` LIMIT 6;";
            ...
            <div class="col-sm-4">
              <div class="product-image-wrapper">
                <div class="single-products">
                    ...
                    <!-- <div class="card" style="width: 29rem; height: 20rem; object-fit:cover; ">
                    <img src="<?php  echo web_root.'admin/products/'. $result->IMAGES; ?>" style="width 100%; height: 100%; object-fit:cover; " class="card-img-top" alt="...">
                    <div class="card-body">
